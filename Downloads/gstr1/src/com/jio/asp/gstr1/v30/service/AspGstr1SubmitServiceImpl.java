...
@Service
public class AspGstr1SubmitServiceImpl implements AspGstr1SubmitService {
	...
	Logger log = LoggerFactory.getLogger(AspGstr1SubmitServiceImpl.class);
	...
	public Map<String, Object> processGstr1Data(Map<String, String> headerData, Map<String, Object> requestData) {
		...
		log.info("Submit GSTR1 API call - Body Validation Successfull - STEP2");
	...
	public Map<String, Object> validateApiInput(Map<String, Object> request) {
		...
		CommonUtil.validateEmptyString(MapUtils.getString(request, Gstr1Constants.INPUT_DATA),
				ErrorCodes.ASP103, Gstr1Constants.ASP_GSTR1_SUBMIT_GRP, "GSTR1_BODY_VAL_ASP302", null,
				HttpStatus.INTERNAL_SERVER_ERROR, messageSource);
		
		data = (Map<String, Object>) request.get(Gstr1Constants.INPUT_DATA);
		
		CommonUtil.validateEmptyString(MapUtils.getString(data, Gstr1Constants.INPUT_GSTN),
				ErrorCodes.ASP103, Gstr1Constants.ASP_GSTR1_SUBMIT_GRP, "GSTR1_BODY_VAL_ASP302", null,
				HttpStatus.INTERNAL_SERVER_ERROR, messageSource);
		
		CommonUtil.validateEmptyString(MapUtils.getString(data, Gstr1Constants.INPUT_GSTN_RET_PER),
				ErrorCodes.ASP103, Gstr1Constants.ASP_GSTR1_SUBMIT_GRP, "GSTR1_BODY_VAL_ASP302", null,
				HttpStatus.INTERNAL_SERVER_ERROR, messageSource);
		
		CommonUtil.validateEmptyString(MapUtils.getString(request, Gstr1Constants.INPUT_GSTN_ACTION),
				ErrorCodes.ASP103, Gstr1Constants.ASP_GSTR1_SUBMIT_GRP, "GSTR1_BODY_VAL_ASP303", null,
				HttpStatus.INTERNAL_SERVER_ERROR, messageSource);
		...
		if (request.containsKey(Gstr1Constants.INPUT_SIGN) || request.containsKey(Gstr1Constants.INPUT_ST)
			...
			CommonUtil.validateEmptyString(MapUtils.getString(request, Gstr1Constants.INPUT_SIGN),
					ErrorCodes.ASP103, Gstr1Constants.ASP_GSTR1_SUBMIT_GRP, "GSTR1_BODY_VAL_ASP304", null,
					HttpStatus.INTERNAL_SERVER_ERROR, messageSource);
	...
	public Map<String, Object> decryptResponse(Map<String, String> headerData, Map<String, Object> gspresponse) {
		...
		try {
			...
			CommonUtil.validateEmptyString(MapUtils.getString(gspresponse, Gstr1Constants.INPUT_DATA),
					ErrorCodes.GSP_NULL_RESPONSE, Gstr1Constants.ASP_GSTR1_SUBMIT_GRP, "GSTR1_GSTN_BODY_EMPTY", null,
					HttpStatus.INTERNAL_SERVER_ERROR, messageSource);
...
//				responseMap.put(Gstr1Constants.ERROR_GRP, Gstr1Constants.ASP_GSTR1_SUBMIT_GRP);
...
//			}
	...
	public void validateHeaderInput(Map<String, String> headerData) {
		...
		CommonUtil.validateEmptyString(MapUtils.getString(headerData, Gstr1Constants.INPUT_SEK),
				ErrorCodes.GSTR1_SUM_EMPTY, Gstr1Constants.ASP_GSTR1_SUBMIT_GRP, "GSTR1_HDR_SEK_ASP105", null,
				HttpStatus.INTERNAL_SERVER_ERROR, messageSource);
		
		CommonUtil.validateEmptyString(MapUtils.getString(headerData, Gstr1Constants.INPUT_APP_KEY),
				ErrorCodes.GSTR1_SUM_TABLE_TYPES_EMTY, Gstr1Constants.ASP_GSTR1_SUBMIT_GRP, "GSTR1_HDR_APP_KEY_ASP106",
	...
	public Map<String, Object> encryptRequest(Map<String, String> headerData, Map<String, Object> request) {
		...
		try {
			...
			responseMap.put(Gstr1Constants.INPUT_GSTN_ACTION, Gstr1Constants.TYPE_SUBMIT);
