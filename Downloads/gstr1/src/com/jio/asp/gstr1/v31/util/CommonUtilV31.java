 ...
 *
 */
public class CommonUtilV31 {
	
	
	public static final Logger log = LoggerFactory.getLogger(CommonUtilV31.class);
	...
	public static void validateEmptyString(String value, String errorCode,String errorGrp, String messageKey, Object[] param, HttpStatus status,
		...
		if (StringUtils.isBlank(value)) {
			...
			excObj.put(Gstr1ConstantsV31.ERROR_CODE, errorCode);
			excObj.put(Gstr1ConstantsV31.ERROR_DESC,msg);
			excObj.put(Gstr1ConstantsV31.ERROR_GRP, errorGrp);
			excObj.put(Gstr1ConstantsV31.ERROR_HTTP_CODE, status);
			log.error(msg);
