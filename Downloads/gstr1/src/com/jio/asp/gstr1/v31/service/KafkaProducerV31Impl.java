...
@Service
public class KafkaProducerV31Impl implements KafkaProducerV31 {
	private static final Logger log = LoggerFactory.getLogger(KafkaProducerV31Impl.class);

	@Autowired
	private KafkaTemplate<String, String> kafkaTemplate;
	@Autowired
	private AspLoggingServiceV31 logService;
			...
			try {
				...
				future.addCallback(new ListenableFutureCallback<SendResult<String, String>>() {
					...
					public void onFailure(Throwable ex) {
						...
						Date date = new Date();
						controlDataMap.put(Gstr1ConstantsV31.CONTROL_REC_UPDTTIME, sdf.format(date));
						incMap.put(Gstr1ConstantsV31.CONTROL_REC_ERRCNT, 1);
